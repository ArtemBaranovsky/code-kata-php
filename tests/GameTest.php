...
class GameTest extends TestCase
{
    ...
    function it_awards_a_one_roll_bonus_for_every_spare()
    {
        ...
        $game->roll(8); // add bonus 8 to previous roll
    ...
    function it_awards_a_one_roll_bonus_for_every_strike()
    {
        $game = new Game();

        $game->roll(10); // strike

        $game->roll(5); //  add bonus 5 to 1-st roll
        $game->roll(2); // add bonus 2 to 1-st roll
    ...
    function a_spare_on_the_final_frame_grants_one_extra_balls()
    {
        ...
        $game->roll(5); // another 5 in a bonus roll
    ...
    function a_strike_on_the_final_frame_grants_two_extra_balls()
    {
        ...
        $game->roll(10); // strike, next 2 rolls are added as a bonus
